            ...
            <ul>
              <li>
                ...
                <p>
                  ...
                  minima distinctio esse in, fuga mollitia molestias
          ...
          {localStorage.getItem("@Token") && (
            <section className="comments-input box">
              ...
              <div className="btn-comments-recommendation">
                <button onClick={()=>document.getElementById("commentTextArea").value="Gostei Muito!"}>Gostei muito!</button>
                <button onClick={()=>document.getElementById("commentTextArea").value="Incrível!"}>Incrível!</button>
                <button  onClick={()=>document.getElementById("commentTextArea").value="Recomendarei para meus amigos!"}>Recomendarei para meus amigos!</button>
              </div>
            </section>
          )}
        </div>
