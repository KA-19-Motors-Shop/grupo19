      ...
      <Modal
        ...
        HeaderBody={
          <form onSubmit={handleSubmit(editProfile)}>
            ...
            <Input register={register} error={errors?.name} label={"Nome"} placeholder="Ex: Samuel" name={"name"} />
            <Input register={register} error={errors?.email} label={"Email"} placeholder="Ex: samuel@gmail.com" name={"email"} />
            <Input register={register} error={errors?.cpf} label={"CPF"} placeholder="Ex: 000.000.000-00" name={"cpf"} />
            <Input register={register} error={errors?.cel} label={"Celular"} placeholder="Ex: (00)99999-9999" name={"cel"} />
            <Input register={register} error={errors?.birthdate} type={"date"} label={"Data de nascimento"} placeholder="Ex: 09/12/1999" name={"birthdate"} />
